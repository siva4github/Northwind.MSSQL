...
namespace Northwind.MSSQL.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        // loading data from strored procedure - 10248
        ...
        [HttpGet("CustomerAndSupplierByCity")]
        public async Task<IEnumerable<CustomerAndSuppliersByCity>> CustomerAndSupplierByCity()
        {
